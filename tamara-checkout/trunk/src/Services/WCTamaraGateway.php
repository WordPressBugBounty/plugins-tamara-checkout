...
class WCTamaraGateway extends WC_Payment_Gateway
{
    ...
    public function init()
    {
        ...
        add_action('init', [$this, 'initTranslatedAttributes'], 20);
    }

    /**
     * Set translatable gateway labels after the text domain is loaded.
     */
    public function initTranslatedAttributes()
    {
        ...
        $this->initGatewayTranslatedAttributes();
    }

    /**
     * Allow child gateways to set translatable labels after the text domain is loaded.
     */
